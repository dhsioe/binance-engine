...
class WebsocketConnection extends AsyncTcpConnection
{
    /**
     * 链接标识
     * @var string
    ...
    public function setLastMsgTime(int $lastMsgTime): void
    {
    ...
    public function setConnectStatus(bool $connectStatus): void
    {
